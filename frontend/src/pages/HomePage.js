...
import { MessageCircle, Snowflake, Languages, MapPin, Calendar, Star } from 'lucide-react';
      ...
      <div className="px-6 py-8 space-y-8">
        <div className="grid grid-cols-2 gap-4">
          <motion.button
            ...
            className="bg-primary text-primary-foreground rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all"
          >
          ...
          >
            ...
            <p className="font-bold text-sm">
              {language === 'ar' ? 'حسب المزاج 🎭' : 'Par Ambiance 🎭'}
            </p>
          </motion.button>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-2xl font-bold">
              {isWinterMode 
                ? (language === 'ar' ? 'توصيات الشتاء ❄️' : 'Recommandations d\'hiver ❄️')
                : (language === 'ar' ? 'نصائح وسيم ⭐' : 'Conseils de Wassim ⭐')}
            </h2>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="font-bold text-sm">
              {language === 'ar' ? 'برامج سياحية' : 'Itinéraires'}
            </p>
            <p className="text-xs opacity-80">
              {language === 'ar' ? '1، 2، 3 أيام' : '1, 2, 3 jours'}
            </p>
          </button>
          ...
          >
            ...
            <p className="text-xs opacity-80">
              {language === 'ar' ? 'أماكن قريبة' : 'Lieux proches'}
            </p>
          </button>
        </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg">
                {language === 'ar' ? 'من هو وسيم؟' : 'Qui est Wassim ?'}
              </h3>
